        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-input bg-card px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 placeholder:text-muted-foreground/60"
          ...
          <div className="mt-10 pt-6 border-t border-border">
            <Button
              variant="outline"
              onClick={signOut}
              className="w-full rounded-xl py-3 gap-2 text-destructive hover:text-destructive"
            >
